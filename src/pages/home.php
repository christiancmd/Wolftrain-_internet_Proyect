...
$jsonData = file_get_contents(filename: '../php/arrayData.json');
$arrayData = json_decode(json: $jsonData, associative: true);
/*
echo "ID : " . $arrayData['IDuser'] . "<br>";
echo "Nombre: " . $arrayData['Full_name'] . "<br>";
echo "Email: " . $arrayData['Email'] . "<br>";
echo "Usuario: " . $arrayData['Name_user'] . '<br>';
*/
            ...
            <div class="product-grid">
                ...
                foreach ($data as $key) { ?>
                    <div class="product">
                        ...
                        <div>
                            <h3><?= "__Plan " . $key['Name_services'] . "__" ?></h3>
                            <p><?= $key['Megas'] . "Megas" ?></p>
                            <p><?= "$" . $key['Price'] ?></p>
