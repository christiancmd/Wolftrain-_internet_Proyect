...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if ($filtro) {
        $unique_filter = getDataUni(filtro: $filtro, conn: $conexion);
    }
}
        ...
        <div id="modal-create" class="modal">
            <div class="modal-content">
                ...
                <form action="../php/createNewUser_db.php" method="POST">
                    ...
                    <div class="input-group">
                        <input class="input" type="password" required id="createPassword" name="Password_create"
                            maxlength="9">
        ...
        <section id="hero">
            ...
            <div class="principal-container-services">
                ...
                <?php } else { ?>
                    ...
                    <?php foreach ($unique_filter as $key) { ?>
                        <tr>
                            <td><?= $key["IDuser"] ?></td>
                            <td><?= $key["Full_name"] ?></td>
                            <td><?= $key["Email"] ?></td>
